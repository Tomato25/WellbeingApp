...
class InvestigationScreen3 extends StatefulWidget {
  InvestigationScreen3(DocumentReference answerRef);
  var ref = answerRef;

  @override
  _InvestigationScreen3State createState() => _InvestigationScreen3State();
}

class _InvestigationScreen3State extends State<InvestigationScreen3> {
  @override
            ...
            Padding(
              ...
              child: new Container(
                  ...
                  child: Row( children: <Widget> [Expanded(child: Padding(
                      ...
                      child: Text("I was anxious yesterday",  textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 26.0, color: Colors.white),
                      )))])
              ),
            )],
        ),
                                  ...
                                  Navigator.push(
                                    ...
                                    PageRouteBuilder(
                                        ...
                                        pageBuilder: (context, animation, animationTime) {
                                          return InvestigationScreen4(answerRef);
                                        }
                                    )
                                )},
                              }),
