...
class SeriesChart2 extends StatefulWidget {
  @override
  _SeriesChart2State createState() => _SeriesChart2State();
}

class _SeriesChart2State extends State<SeriesChart2> {
  ...
  _generateData(mydata) {
    ...
    _seriesBarData.add(
      charts.Series(
        ...
        measureFn: (Record record, _) => int.parse(record.Question2),
...
class BarChart2 extends StatefulWidget {
  @override
  _BarChart2State createState() => _BarChart2State();
}
