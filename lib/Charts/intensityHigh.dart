...
class highIntensityChart extends StatefulWidget {
  @override
  _highIntensityChartState createState() => _highIntensityChartState();
}

class _highIntensityChartState extends State<highIntensityChart> {
...
Widget _buildBody(BuildContext context) {
  ...
  return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('answers').doc(auth.currentUser.uid).collection("answer").where("question6", isGreaterThanOrEqualTo: 3).snapshots(),
