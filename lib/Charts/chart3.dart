...
class Chart3 extends StatefulWidget {
  ...
  @override
  _Chart3State createState() => _Chart3State();
}
...
class SeriesChart3 extends StatefulWidget {
  @override
  _SeriesChart3State createState() => _SeriesChart3State();
}

class _SeriesChart3State extends State<SeriesChart3> {
  ...
  _generateData(mydata) {
    ...
    _seriesBarData.add(
      charts.Series(
        ...
        measureFn: (Record record, _) => int.parse(record.Question3),
...
class BarChart3 extends StatefulWidget {
  @override
  _BarChart3State createState() => _BarChart3State();
}
