...
class Chart4 extends StatefulWidget {
  ...
  @override
  _Chart4State createState() => _Chart4State();
}
...
class SeriesChart4 extends StatefulWidget {
  @override
  _SeriesChart4State createState() => _SeriesChart4State();
}

class _SeriesChart4State extends State<SeriesChart4> {
  ...
  _generateData(mydata) {
    ...
    _seriesBarData.add(
      charts.Series(
        ...
        measureFn: (Record record, _) => int.parse(record.Question4),
...
class BarChart4 extends StatefulWidget {
  @override
  _BarChart4State createState() => _BarChart4State();
}
