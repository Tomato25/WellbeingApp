...
class lowDurationWorkout extends StatefulWidget {
  @override
  _lowDurationWorkoutState createState() => _lowDurationWorkoutState();
}

class _lowDurationWorkoutState extends State<lowDurationWorkout> {
...
Widget _buildBody(BuildContext context) {
  ...
  return StreamBuilder<QuerySnapshot>(
      stream: FirebaseFirestore.instance.collection('answers').doc(auth.currentUser.uid).collection("answer").where("question7", isLessThanOrEqualTo: 30).snapshots(),
