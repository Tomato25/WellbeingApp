...
class InvestigationScreen2 extends StatefulWidget {
  InvestigationScreen2(DocumentReference answerRef);
  var ref = answerRef;
  @override
  _InvestigationScreen2State createState() => _InvestigationScreen2State();
}

class _InvestigationScreen2State extends State<InvestigationScreen2> {
  @override
            ...
            Padding(
              ...
              child: new Container(
                  ...
                  child: Row( children: <Widget> [Expanded(child: Padding(
                      ...
                      child: Text("I was happy yesterday",  textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 26.0, color: Colors.white),
                      )))])
              ),
            )],
        ),
                                  ...
                                  Navigator.push(
                                    ...
                                    PageRouteBuilder(
                                        ...
                                        pageBuilder: (context, animation, animationTime) {
                                          return InvestigationScreen3(answerRef);
                                        }
                                    )
                                )},
                              }),
                          ...
                          IconButton(
                            ...
                            { answerRef
                              ...
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (context) => InvestigationScreen3(answerRef)))},
                          ),
