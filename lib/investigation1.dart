...
class InvestigationScreen1 extends StatefulWidget {
  InvestigationScreen1(DocumentReference answerRef);

  var ref = answerRef;
  @override
  _InvestigationScreen1State createState() => _InvestigationScreen1State();
}

class _InvestigationScreen1State extends State<InvestigationScreen1> {
  @override
            ...
            Padding(
              ...
              child: new Container(
                  ...
                  child: Row( children: <Widget> [Expanded(child: Padding(
                      ...
                      child: Text("What I do in my life is worthwhile",  textAlign: TextAlign.center, style: GoogleFonts.montserrat(fontSize: 26.0, color: Colors.white),
                      )))])
              ),
            )],
        ),
                                  ...
                                  Navigator.push(
                                    ...
                                    PageRouteBuilder(
                                        ...
                                        pageBuilder: (context, animation, animationTime) {
                                          return InvestigationScreen2(answerRef);
                                        }
                                    )
                                )},
                              }),
